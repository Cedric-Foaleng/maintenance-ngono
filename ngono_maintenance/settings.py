"""
Django settings for ngono_maintenance project.
...
# ❌ ERREUR - Supprime tout ça
# ALLOWED_HOSTS = ['192.168.1.15']
# ALLOWED_HOSTS = []

# ✅ SOLUTION 100% FONCTIONNELLE
#ALLOWED_HOSTS = ['*']  # ← TOUT LE RÉSEAU LOCAL

#DEBUG = True  # ← OBLIGATOIRE


# Remplace la ligne ALLOWED_HOSTS
# ✅ CONFIGURATION POUR TOUS LES UTILISATEURS (PC + 📱 + 💻)
# Juste après BASE_DIR = Path(__file__).resolve().parent.parent
...
ROOT_URLCONF = 'ngono_maintenance.urls'
...
WSGI_APPLICATION = 'ngono_maintenance.wsgi.application'
